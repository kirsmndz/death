...
int main(){
    ...
    while (1) { /// while its true (missing: it has to end eventually) what is true ba? how is it supposed to end?
        ch = getch();
        ...
        password[characterPosition] = ch; //copies number of characters to print asterisks
        characterPosition++;
        printf("*");
        }
    } /// loop is not ending
